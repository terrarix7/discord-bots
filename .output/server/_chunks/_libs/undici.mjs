...
function requireClientH1 () {
	...
	async function lazyllhttp () {
	  const llhttpWasmData = process.env.JEST_WORKER_ID ? /*@__PURE__*/ requireLlhttpWasm() : undefined;
	...
	function writeH1 (client, request) {
	  ...
	  if (util.isFormDataLike(body)) {
	    if (!extractBody) {
	      extractBody = /*@__PURE__*/ requireBody().extractBody;
	    }
...
function requireSymbols$1 () {
	...
	symbols$1 = {
	  kConstruct: /*@__PURE__*/ requireSymbols$4().kConstruct
	};
	return symbols$1;
}
...
function requireUndici () {
	...
	const api = /*@__PURE__*/ requireApi();
	const buildConnector = /*@__PURE__*/ requireConnect();
	const MockClient = /*@__PURE__*/ requireMockClient();
	const MockAgent = /*@__PURE__*/ requireMockAgent();
	const MockPool = /*@__PURE__*/ requireMockPool();
	const mockErrors = /*@__PURE__*/ requireMockErrors();
	const RetryHandler = /*@__PURE__*/ requireRetryHandler();
	...
	const fetchImpl = /*@__PURE__*/ requireFetch().fetch;
	...
	undici.Headers = /*@__PURE__*/ requireHeaders().Headers;
	undici.Response = /*@__PURE__*/ requireResponse().Response;
	undici.Request = /*@__PURE__*/ requireRequest().Request;
	undici.FormData = /*@__PURE__*/ requireFormdata().FormData;
	undici.File = globalThis.File ?? require$$0.File;
	undici.FileReader = /*@__PURE__*/ requireFilereader().FileReader;
	...
	undici.WebSocket = /*@__PURE__*/ requireWebsocket().WebSocket;
