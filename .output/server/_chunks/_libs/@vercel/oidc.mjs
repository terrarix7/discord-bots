	...
	async function getVercelOidcToken(options) {
	  ...
	  try {
	    const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([
	      await Promise.resolve().then(function () { return tokenUtil$4; }),
	      await Promise.resolve().then(function () { return token$4; })
	    ]);
...
function requireTokenIo$1 () {
	...
	var import_path = __toESM(require$$0__default);
	var import_fs = __toESM(fs__default);
	var import_os = __toESM(require$$0);
	var import_token_error = /*@__PURE__*/ requireTokenError$1();
...
function requireAuthConfig () {
	...
	var fs = __toESM(fs__default);
	var path = __toESM(require$$0__default);
...
function requireTokenUtil$1 () {
	...
	var import_auth_errors = /*@__PURE__*/ requireAuthErrors();
...
function requireGetVercelOidcToken () {
	...
	async function getVercelOidcToken() {
	  ...
	  try {
	    const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([
	      await Promise.resolve().then(function () { return tokenUtil$1; }),
	      await Promise.resolve().then(function () { return token$1; })
	    ]);
...
export { distExports as a, distExports$1 as d };
